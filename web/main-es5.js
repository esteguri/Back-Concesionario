...
var AutosComponent = /** @class */ (function () {
    ...
    AutosComponent.prototype.consultarPlaca = function (input) {
        var _this = this;
        ...
        this.apiConcesionario.consultarAutoXPlaca(input.value).subscribe(function (response) {
            if (response.error == "500") {
                sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
                    title: "Oops...",
                    text: 'No existe',
    ...
    AutosComponent.prototype.borrarAuto = function (auto, i) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
            title: "¿Esta Seguro?",
            ...
            if (resp.value) {
                _this.autos.splice(i, 1);
                _this.apiConcesionario.borrarAuto(auto.id).subscribe(function (response) {
                    if (response.error == "500") {
                        sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
                            title: "Oops...",
...
var EmpleadoComponent = /** @class */ (function () {
    function EmpleadoComponent(apiConcesionario, route, router) {
        this.apiConcesionario = apiConcesionario;
        this.route = route;
        this.router = router;
    ...
    EmpleadoComponent.prototype.ngOnInit = function () {
        ...
        if (id == "nuevo") {
            ...
            this.apiConcesionario.consultarEmpleadoXId(id).subscribe(function (resp) {
                if (resp.error) {
                    _this.router.navigate(['/empleados']);
                }
                else {
                    _this.empleado = resp;
                    _this.title = resp.nombre + " " + resp.apellido;
                }
            });
        }
    };
    EmpleadoComponent.prototype.consultarSucursales = function () {
        var _this = this;
        this.apiConcesionario.consultarSucursales().subscribe(function (response) {
            if (response.error == "500") {
                sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
                    title: "Oops...",
                    text: 'No existe',
    ...
    EmpleadoComponent.prototype.guardar = function (form) {
        var _this = this;
        if (form.status == "INVALID") {
            sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
                title: "Oops...",
        ...
        if (!this.empleado.id) {
            ...
            this.apiConcesionario.actualizarEmpleado(this.empleado).subscribe(function (response) {
                if (response.error == "200") {
                    sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
                        title: _this.empleado.nombre + ' ' + _this.empleado.apellido,
    ...
    EmpleadoComponent.ctorParameters = function () { return [
        { type: _services_api_concesionario_service__WEBPACK_IMPORTED_MODULE_2__["ApiConcesionarioService"] },
...
var EmpleadosConsultasComponent = /** @class */ (function () {
    function EmpleadosConsultasComponent(apiConcesionario) {
        this.apiConcesionario = apiConcesionario;
        this.sucursales = [];
        this.empleados = [];
    }
    EmpleadosConsultasComponent.prototype.ngOnInit = function () {
        this.consultarSucursales();
    };
    EmpleadosConsultasComponent.prototype.consultarFecha = function (input) {
        var _this = this;
        if (input.value == null || input.value == "") {
            sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
                title: "Oops...",
        ...
        this.apiConcesionario.consultarEmpleadoXFechaIngreso(input.value).subscribe(function (response) {
            if (response.error == "500") {
                sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
                    title: "Oops...",
                    text: 'No existe',
    ...
    EmpleadosConsultasComponent.prototype.consultarSucursal = function (input) {
        var _this = this;
        if (input.value == null || input.value == "") {
            sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
                title: "Oops...",
        ...
        this.apiConcesionario.consultarEmpleadoXSucursal(input.value).subscribe(function (response) {
            if (response.error == "500") {
                sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
                    title: "Oops...",
                    text: 'No existe',
    ...
    EmpleadosConsultasComponent.prototype.consultarSucursales = function () {
        var _this = this;
        this.apiConcesionario.consultarSucursales().subscribe(function (response) {
            if (response.error == "500") {
                sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
    ...
    EmpleadosConsultasComponent.ctorParameters = function () { return [
        { type: _services_api_concesionario_service__WEBPACK_IMPORTED_MODULE_2__["ApiConcesionarioService"] }
    ]; };
    ...
    return EmpleadosConsultasComponent;
}());
...
var EmpleadosComponent = /** @class */ (function () {
    function EmpleadosComponent(apiConcesionario) {
        this.apiConcesionario = apiConcesionario;
        this.cargando = false;
        this.empleados = [];
    }
    EmpleadosComponent.prototype.ngOnInit = function () {
        ...
        this.cargando = true;
        setTimeout(function () {
            _this.consultarEmpleados();
        }, 800);
    };
    EmpleadosComponent.prototype.consultarEmpleados = function () {
        var _this = this;
        this.apiConcesionario.consultarEmpleados().subscribe(function (response) {
            if (response.error == "500") {
                _this.cargando = false;
    ...
    EmpleadosComponent.prototype.consultarId = function (input) {
        var _this = this;
        if (input.value == "" || isNaN(input.value)) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
                title: "Oops...",
        ...
        this.apiConcesionario.consultarEmpleadoXId(input.value).subscribe(function (response) {
            if (response.error == "500") {
                sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
                    title: "Oops...",
                    text: 'No existe',
                ...
                var resp = [];
                resp.push(response);
                _this.empleados = resp;
            }
        });
    };
    EmpleadosComponent.prototype.consultarCedula = function (input) {
        var _this = this;
        if (input.value == "" || input.value.length < 3) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
                title: "Oops...",
        ...
        this.apiConcesionario.consultarEmpleadoXCedula(input.value).subscribe(function (response) {
            if (response.error == "500") {
                sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
                    title: "Oops...",
                    text: 'No existe',
    ...
    EmpleadosComponent.prototype.borrarEmpleado = function (empleado, i) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
            title: "¿Esta Seguro?",
            ...
            if (resp.value) {
                _this.apiConcesionario.borrarEmpleado(empleado.id).subscribe(function (response) {
                    if (response.error == "500") {
                        sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
                            title: "Oops...",
                        ...
                        _this.empleados.splice(i, 1);
                    }
                });
            }
        });
    };
    EmpleadosComponent.ctorParameters = function () { return [
        { type: _services_api_concesionario_service__WEBPACK_IMPORTED_MODULE_2__["ApiConcesionarioService"] }
    ]; };
...
var SucursalComponent = /** @class */ (function () {
    function SucursalComponent(apiConcesionario, route, router) {
        this.apiConcesionario = apiConcesionario;
        this.route = route;
        this.router = router;
    ...
    SucursalComponent.prototype.ngOnInit = function () {
        ...
        if (id == "nuevo") {
            ...
            this.apiConcesionario.consultarSucursalXId(id).subscribe(function (resp) {
                if (resp.error) {
    ...
    SucursalComponent.prototype.guardar = function (form) {
        var _this = this;
        if (form.status == "INVALID") {
            sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
                title: "Oops...",
        ...
        if (!this.sucursal.id) {
            this.apiConcesionario.insertarSucursal(this.sucursal).subscribe(function (response) {
                if (response.error == "200") {
                    sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
                        title: _this.sucursal.nombre,
            ...
            this.apiConcesionario.actualizarSucursal(this.sucursal).subscribe(function (response) {
                if (response.error == "200") {
                    sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
                        title: _this.sucursal.nombre,
    ...
    SucursalComponent.ctorParameters = function () { return [
        { type: _services_api_concesionario_service__WEBPACK_IMPORTED_MODULE_2__["ApiConcesionarioService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }
    ]; };
...
var SucursalesComponent = /** @class */ (function () {
    function SucursalesComponent(apiConcesionario) {
        this.apiConcesionario = apiConcesionario;
        this.cargando = false;
        this.sucursales = [];
    }
    SucursalesComponent.prototype.ngOnInit = function () {
        ...
        this.cargando = true;
        setTimeout(function () {
            _this.consultarSucursales();
        }, 800);
    };
    SucursalesComponent.prototype.consultarSucursales = function () {
        var _this = this;
        this.apiConcesionario.consultarSucursales().subscribe(function (response) {
            if (response.error == "500") {
                _this.cargando = false;
    ...
    SucursalesComponent.prototype.consultarId = function (input) {
        var _this = this;
        if (input.value == "" || isNaN(input.value)) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
                title: "Oops...",
        ...
        this.apiConcesionario.consultarSucursalXId(input.value).subscribe(function (response) {
            if (response.error == "500") {
                sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
                    title: "Oops...",
                    text: 'No existe',
                ...
                var resp = [];
                resp.push(response);
                _this.sucursales = resp;
            }
        });
    };
    SucursalesComponent.prototype.consultarNombre = function (input) {
        var _this = this;
        if (input.value == "" || input.value.length < 3) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
                title: "Oops...",
        ...
        this.apiConcesionario.consultarSucursalXNombre(input.value).subscribe(function (response) {
            if (response.error == "500") {
                sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
                    title: "Oops...",
                    text: 'No existe',
    ...
    SucursalesComponent.prototype.borrarSucursal = function (sucursal, i) {
        var _this = this;
        sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
            title: "¿Esta Seguro?",
            ...
            if (resp.value) {
                _this.apiConcesionario.borrarSucursal(sucursal.id).subscribe(function (response) {
                    if (response.error == "500") {
                        sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
                            title: "Oops...",
                        ...
                        _this.sucursales.splice(i, 1);
                    }
                });
            }
        });
    };
    SucursalesComponent.ctorParameters = function () { return [
        { type: _services_api_concesionario_service__WEBPACK_IMPORTED_MODULE_2__["ApiConcesionarioService"] }
    ]; };
...
var ApiConcesionarioService = /** @class */ (function () {
    ...
    ApiConcesionarioService.prototype.consultarAutoXPlaca = function (termino) {
    ...
    ApiConcesionarioService.prototype.borrarAuto = function (id) {
    ...
    ApiConcesionarioService.prototype.consultarSucursales = function () {
        return this.http.get(this.url + "/api/sucursal?search=sucursales", {});
    };
    ApiConcesionarioService.prototype.consultarEmpleadoXFechaIngreso = function (termino) {
        return this.http.get(this.url + ("/api/empleado?search=ingreso&ingreso=" + termino), {});
    };
    ApiConcesionarioService.prototype.consultarEmpleadoXSucursal = function (termino) {
        return this.http.get(this.url + ("/api/empleado?search=sucursal&sucursal=" + termino), {});
    };
    ApiConcesionarioService.prototype.consultarEmpleadoXId = function (termino) {
        return this.http.get(this.url + ("/api/empleado?search=id&id=" + termino), {});
    };
    ApiConcesionarioService.prototype.consultarEmpleadoXCedula = function (termino) {
        return this.http.get(this.url + ("/api/empleado?search=cedula&cedula=" + termino), {});
    };
    ApiConcesionarioService.prototype.borrarEmpleado = function (id) {
        return this.http.delete(this.url + ("/api/empleado?id=" + id), {});
    };
    ApiConcesionarioService.prototype.insertarEmpleado = function (json) {
    ...
    ApiConcesionarioService.prototype.actualizarEmpleado = function (json) {
    ...
    ApiConcesionarioService.prototype.consultarSucursalXId = function (termino) {
        return this.http.get(this.url + ("/api/sucursal?search=id&id=" + termino), {});
    };
    ApiConcesionarioService.prototype.consultarSucursalXNombre = function (termino) {
        return this.http.get(this.url + ("/api/sucursal?search=nombre&nombre=" + termino), {});
    };
    ApiConcesionarioService.prototype.borrarSucursal = function (id) {
        return this.http.delete(this.url + ("/api/sucursal?id=" + id), {});
    };
    ApiConcesionarioService.prototype.insertarSucursal = function (json) {
        return this.http.post(this.url + ("/api/sucursal?nombre=" + json.nombre + "&descripcion=" + json.descripcion), {});
    };
    ApiConcesionarioService.prototype.actualizarSucursal = function (json) {
