...
let AutoComponent = class AutoComponent {
    ...
    guardar(form) {
        ...
        if (!this.auto.id) {
            this.apiConcesionario.consultarAutoXPlaca(this.auto.placa).subscribe((response) => {
...
let EmpleadoComponent = class EmpleadoComponent {
    ...
    guardar(form) {
        ...
        if (!this.empleado.id) {
            this.apiConcesionario.consultarEmpleadoXCedula(this.empleado.cedula).subscribe((response) => {
                if (response.error == "500") {
